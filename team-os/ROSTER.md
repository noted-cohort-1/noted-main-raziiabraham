...
Small team. Keep this file current — `feature-index.yaml` references owners by the GitHub handles below.

## Team

| Name | GitHub | Role | Owns |
|---|---|---|---|
...
## Merge rules (mirror of `.github/CODEOWNERS`)

- **`team-os/**`** — any teammate can open and merge a PR. No required approver.
- **Everything else** — `@avidx-app` is the required reviewer. Open a PR, ping for review.

## How to update this file

Just edit and open a PR. Anyone can approve a `ROSTER.md` change.
