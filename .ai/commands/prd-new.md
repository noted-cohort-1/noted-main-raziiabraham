---
description: Scaffold a new PRD using team-os conventions
argument-hint: "[area/slug or free-form feature name]"
---

# /prd-new

Scaffold a new PRD in `team-os/product/prds/<area>/<slug>-prd.md`.
...
2. Invoke the `prd-writer` skill — it will ask clarifying questions first.
