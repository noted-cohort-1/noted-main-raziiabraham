...
4. **Before opening a PR** — run `/noted-review` in Claude/Cursor or `$noted-review` in Codex, then follow the [code-quality-checklist](.ai/skills/code-quality-checklist/SKILL.md).
