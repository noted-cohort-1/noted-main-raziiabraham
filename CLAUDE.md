...
| **Claude config** | [.claude/CLAUDE.md](.claude/CLAUDE.md) | Skills, commands, and subagents available in this repo |
...
- **Setup**: `npm install` → `npm run dev` (with `npx convex dev` in a second terminal).
